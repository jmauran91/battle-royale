...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _GameContainer = __webpack_require__(160);
	...
	var App = function (_Component) {
	  ...
	  function App(props) {
	    ...
	    _this.handleGameToggleClick = _this.handleGameToggleClick.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(App, [{
	    ...
	    key: 'handleGameToggleClick',
	    value: function handleGameToggleClick() {
	    ...
	    value: function render() {
	      ...
	      var renderGame = void 0;
	      if (this.state.gameToggle) {
	        renderGame = function renderGame() {
	          return _react2.default.createElement(_GameContainer2.default, {
	            remaining: _this3.state.remaining,
	            deckId: _this3.state.deckId
	          });
	        };
	      } else {
	        renderGame = function renderGame() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GameContainer = function (_Component) {
	  ...
	  _createClass(GameContainer, [{
	    ...
	    key: 'getComputerDeck',
	    value: function getComputerDeck() {
	      var _this2 = this;

	      var deckster = this.props.deckId;
	      fetch('https://deckofcardsapi.com/api/deck/' + deckster + '/draw/?count=26').then(function (response) {
	        return response.json();
	      }).then(function (responseData) {
	        debugger;
	        _this2.setState({});
